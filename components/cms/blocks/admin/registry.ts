...
import type { AdminBlockProps } from "./types"
...
/**
 * Maps each block type to its admin-preview component. A type absent from this
 * map renders nothing (preserves the old `default: return null` behaviour).
 */
export const adminBlockRegistry: Partial<
  Record<BlockType, ComponentType<AdminBlockProps>>
> = {
  hero: HeroBlock,
